			...
			<div class="container">
				<div class="row p-2 pt-4 bg-white">
					...
					<div class="col-lg-6 product-details pl-md-5 ftco-animate">
						...
						<p class="price"><span>Rp. 25.000/kg</span></p>
			...
			<div class="row">
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="product">
						...
						<div class="text py-3 pb-4 px-3 text-center">
							<h3><a href="#">Paprika</a></h3>
							<div class="d-flex">
								<div class="pricing">
									<p class="price"><span class="mr-2 price-dc">Rp. 45.000/kg</span><span
											class="price-sale">Rp. 35.000/kg</span></p>
								</div>
							</div>
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="product">
						...
						<div class="text py-3 pb-4 px-3 text-center">
							<h3><a href="#">Beras</a></h3>
							<div class="d-flex">
								<div class="pricing">
									<p class="price"><span>Rp. 49.000/kg</span></p>
								</div>
							</div>
							<div class="bottom-area d-flex px-3">
								<div class="m-auto d-flex">
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="product">
						...
						<div class="text py-3 pb-4 px-3 text-center">
							<h3><a href="#">Beras Fortune 5kg</a></h3>
							<div class="d-flex">
								<div class="pricing">
									<p class="price"><span>Rp. 48.000</span></p>
								</div>
							</div>
							<div class="bottom-area d-flex px-3">
								<div class="m-auto d-flex">
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="product">
						...
						<div class="text py-3 pb-4 px-3 text-center">
							<h3><a href="#">Kubis Ungu</a></h3>
							<div class="d-flex">
								<div class="pricing">
									<p class="price"><span>Rp. 25.0000/kg</span></p>
								</div>
							</div>
							<div class="bottom-area d-flex px-3">
								<div class="m-auto d-flex">
